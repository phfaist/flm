...
all_builtin_specinfo_classes = {
    # flm.flmspecinfo
    'flm.flmspecinfo:ConstantValueMacro': flm.flmspecinfo.ConstantValueMacro,
    'flm.flmspecinfo:ConstantValueEnvironment': flm.flmspecinfo.ConstantValueEnvironment,
    ...
    'flm.feature.graphics:SimpleIncludeGraphicsMacro': flm.feature.graphics.SimpleIncludeGraphicsMacro,
    ...
    # 'flm.docgen.docgen:EnvironmentDocArguments': flm.docgen.docgen.EnvironmentDocArguments,
