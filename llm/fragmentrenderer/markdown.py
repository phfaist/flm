...
class MarkdownFragmentRenderer(FragmentRenderer):
    ...
    def render_build_paragraph(self, nodelist, render_context):
        ...
        md_indent = render_context.get_logical_state('llm_markdown').get('md_indent', '')
        if md_indent != '':
    ...
    def render_enumeration(self, iter_items_nodelists, counter_formatter, render_context,
        ...
        mdindent_cur = render_context.get_logical_state('llm_markdown').get('md_indent', '')
        mdindent = mdindent_cur + '  '
        with render_context.push_logical_state('llm_markdown', 'indent', mdindent):
    ...
    def render_float(self, float_instance, render_context):
        # see llm.feature.floats for FloatInstance
